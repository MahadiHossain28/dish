                ...
                <div class="cardform">
                    ...
                    <center>
                        <form class="login-form">
                            ...
                            <label>Image</label>
                            <input type="file" for="image" name="image" id="image" class="form-control image" style="width:25rem;" required>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <img src="{{asset('/uploads/WastedFoodImage/'.$wastedfooditem->image)}}" alt="image" width="70" height="70" class="img img-responsive" />
                                @endif
                            </td>
                            <td>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="{{route('edit_wastedfooditems',$wastedfooditem->id)}}"><i style="font-size: 10px;" class="fas fa-pencil-alt"></i></a>
                                    </div>
                                    <div class="col">
                                        <a href="{{route('delete_wastedfooditems',$wastedfooditem->id)}}"><i style="font-size: 10px;" class="fa fa-trash text-danger"></i></a>
                                    </div>
                                </div>
                            </td>
